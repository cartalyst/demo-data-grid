<div class="data-grid" data-example="oranges" data-grid="oranges">
    <header>
        <h3>Orange Harvests <span>Production quantities, 2012-2013</span></h3>
...
{{-- Templates --}}
@include('demo/examples/fruits/grid/oranges-results')
@include('demo/examples/fruits/grid/oranges-pagination')
