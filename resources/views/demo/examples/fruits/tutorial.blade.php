    ...
    <div class="tabs-content" data-tabs-content="tutorial-tabs">
        <div class="tabs-panel is-active" id="controller">
            <article class="article article--tutorial">
                ...
                <p>{!! renderCode('app/Http/Controllers/Demo/Examples/FruitsController.php', 'php') !!}</p>
            </article>
        </div>
        ...
        <div class="tabs-panel" id="instantiate">
            <article class="article article--tutorial">
                ...
                <p>{!! renderCode('resources/views/demo/examples/fruits/init-js.blade.php', 'js') !!}</p>
            </article>
        </div>
        ...
        <div class="tabs-panel" id="grid">
            <article class="article article--tutorial">
                ...
                <p>{!! renderCode('resources/views/demo/examples/fruits/apples.blade.php', 'html') !!}</p>

                <h5>oranges.blade.php</h5>
                <p>{!! renderCode('resources/views/demo/examples/fruits/oranges.blade.php', 'html') !!}</p>
            </article>
        </div>
        ...
        <div class="tabs-panel" id="results">
            <article class="article article--tutorial">
                ...
                <p>{!! renderCode('resources/views/demo/examples/fruits/grid/apples-results.blade.php', 'js') !!}</p>

                <h5>grid/oranges-results.blade.php</h5>
                <p>{!! renderCode('resources/views/demo/examples/fruits/grid/oranges-results.blade.php', 'js') !!}</p>
            </article>
        </div>
        ...
        <div class="tabs-panel" id="pagination">
            <article class="article article--tutorial">
                ...
                <p>{!! renderCode('resources/views/demo/examples/fruits/grid/apples-pagination.blade.php', 'js') !!}</p>

                <h5>grid/oranges-pagination.blade.php</h5>
                <p>{!! renderCode('resources/views/demo/examples/fruits/grid/oranges-pagination.blade.php', 'js') !!}</p>
            </article>
        </div>
    </div>
</section>
