    ...
    <div class="tabs-content" data-tabs-content="tutorial-tabs">
        <div class="tabs-panel is-active" id="controller">
            <article class="article article--tutorial">
                ...
                <p>{!! renderCode('app/Http/Controllers/Demo/Examples/CropsController.php', 'php') !!}</p>
            </article>
        </div>
        ...
        <div class="tabs-panel" id="instantiate">
            <article class="article article--tutorial">
                ...
                <p>{!! renderCode('resources/views/demo/examples/crops/init-js.blade.php', 'js') !!}</p>
            </article>
        </div>
        ...
        <div class="tabs-panel" id="grid">
            <article class="article article--tutorial">
                ...
                <p>{!! renderCode('resources/views/demo/examples/crops/grid.blade.php', 'html') !!}</p>
            </article>
        </div>
        ...
        <div class="tabs-panel" id="layouts">
            <article class="article article--tutorial">
                ...
                <p>{!! renderCode('resources/views/demo/examples/crops/grid/table.blade.php', 'js') !!}</p>
                ...
                <h5>grid.blade.php</h5>
                <p>{!! renderCode('resources/views/demo/examples/crops/grid/blocks.blade.php', 'js') !!}</p>
                ...
                <p>{!! renderCode('resources/views/demo/examples/crops/grid/count.blade.php', 'js') !!}</p>
            </article>
        </div>
        ...
        <div class="tabs-panel" id="pagination">
            <article class="article article--tutorial">
                ...
                <p>{!! renderCode('resources/views/demo/examples/crops/grid/pagination.blade.php', 'js') !!}</p>
            </article>
        </div>
    </div>
</section>
