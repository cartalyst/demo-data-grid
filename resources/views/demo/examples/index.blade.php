...
<script>
    $(function() {
        ...
        var grid = dg.create('examples', {
            source: '{{ route('demo.examples.source') }}',
        });
    });
</script>
@stop
...
<div class="page__body">
    <div class="row small-collapse medium-uncollapse align-stretch small-up-1 medium-up-3" data-grid="examples" data-grid-layout="results"></div>
</div>
